...
class PreTrip extends StatefulWidget {
  PreTrip({Key? key}) : super(key: key);

  @override
  _PreTripState createState() => _PreTripState();
}

class _PreTripState extends State<PreTrip> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<CdlStudent>> getStudent() =>
        WebApi().getPreTrip(cdlSchool.schoolId);
