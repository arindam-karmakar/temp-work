// ignore_for_file: no_leading_underscores_for_local_identifiers, unnecessary_new, prefer_interpolation_to_compose_strings, curly_braces_in_flow_control_structures

import 'dart:convert';

import 'package:eldtprep/api/httpHandle.dart';
...
class WebApi {
  final String _apiKey = '6cc9fff2-0b29-44f1-8b74-aedf1abc6c7a';
  final String _baseUrl = 'www.eldtinc.com';

  final String _getCategoryListPath = 'prep/api/getcategorylist';
  final String _sendOtpPath = 'prep/api/sendotpviaphone';
  final String _changePasswordPath = 'prep/api/changepswd';
  //final String _profilePictureUpdatePath = 'prep/api/profilepicupdate';
  final String _getStateListPath = 'prep/api/getstatelist';
  final String _getQuestionPath = 'prep/api/quesbystatecategory';
  final String _setScorePath = 'prep/api/setscorebyuser';
  final String _validatePhonePath = 'prep/api/validatephone';
  final String _preTripPath = 'prep/api/getenrollbypretrip';
  final String _skillPath = 'prep/api/getenrollbyskillready';
  final String _roadPath = 'prep/api/getenrollbyroadready';
  final String _enrolledToSchoolPath = 'prep/api/getenrolllist';
  final String _enrollStudentPath = 'prep/api/addenroll';
  final String _enrollSetSlotPath = 'prep/api/setslotbyenroll';
  final String _enrollGetSlotPath = 'prep/api/getslotbyenroll';
  final String _getUserIdPath = 'prep/api/userbyphone';
  final String _getSlotByDatePath = 'prep/api/getslotbyschool';
  final String _setNotifPath = 'prep/api/setnotification';
  final String _getNotifPath = 'prep/api/getnotification';
  final String _editNotifPath = 'prep/api/editnotification';
  final String _notifCountPath = 'prep/api/notificationcount';
  final String _markNotifPath = 'prep/api/readnotification';
...
class GlobalSearchProvider extends ChangeNotifier {
  ...
  final String _enrollByNamePath = 'prep/api/getenrollbyname';
  final String _enrollByPhonePath = 'prep/api/getenrollbyphone';
  final String _preTripPath = 'prep/api/getenrollbypretrip';
  final String _skillPath = 'prep/api/getenrollbyskillready';
  final String _roadPath = 'prep/api/getenrollbyroadready';
...
class AuthProvider extends ChangeNotifier {
  ...
  final String _loginPath = 'prep/api/login';
  final String _signupPath = 'prep/api/signup';
  final String _schoolSetPassword = 'prep/api/setpswd';
  final String _updatePath = 'prep/api/updateschool';
  final String _updatePathStudent = 'prep/api/profilechange';
  final String _updatePicPath = 'prep/api/profilepicupdate';
