...
class RoadReady extends StatefulWidget {
  RoadReady({Key? key}) : super(key: key);

  @override
  _RoadReadyState createState() => _RoadReadyState();
}

class _RoadReadyState extends State<RoadReady> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<CdlStudent>> getStudent() =>
        WebApi().getRoad(cdlSchool.schoolId);
